...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let count = 0;
            core.info(`Checking if service ${service} is stable in cluster ${cluster}. Will try ${attempts} attempts.`);
            while (count <= attempts) {
                const data = yield aws.command(`ecs describe-services --cluster ${cluster} --services ${service}`);
                const deployments = data.object.services[0].deployments.length;
                const desiredCount = data.object.services[0].desiredCount;
                const runningCount = data.object.services[0].runningCount;
