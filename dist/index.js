...
const isStable_1 = __webpack_require__(402);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const attempts = parseInt(core.getInput('attempts'), 10);
            ...
            while (count <= attempts) {
                if (isStable_1.isStable(accessKey, secretKey, cluster, service)) {
                    core.info(`Service is stable`);
                    return;
                }
                else {
                    yield wait_1.wait(1500);
                    count++;
                }
            }
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isStable = void 0;
const core = __importStar(__webpack_require__(186));
const aws_cli_js_1 = __webpack_require__(111);
function isStable(accessKey, secretKey, cluster, service) {
    return __awaiter(this, void 0, void 0, function* () {
        const options = new aws_cli_js_1.Options(accessKey, secretKey);
        const aws = new aws_cli_js_1.Aws(options);
        const data = yield aws.command(`aws ecs describe-services --cluster ${cluster} --services "${service}"`);
        const deployments = data.object.deployments;
        const desiredCount = data.object.desiredCount;
        const runningCount = data.object.runningCount;
...
const nodeify_ts_1 = __importDefault(__webpack_require__(694));
